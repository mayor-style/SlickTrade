...
const CTA = () => {
  return (
    <section className='py-[100px] border-b border-t border-t-gold border-b-dark-gray border-dashed  px-[20px] sm:px-[100px] text-center text-white flex flex-col gap-5'>
