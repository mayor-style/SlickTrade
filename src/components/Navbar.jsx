...
const Navbar = () => {
  return (
    <nav className='p-4 justify-between fixed top-0 left-0 right-0 flex lg:justify-around w-full items-center text-white overflow-hidden'>
      <div className="flex justify-center  items-center gap-1 lg:w-full">
        <img src={logo} alt="" className='sm:max-w-12 h-auto max-w-10'/>
    ...
    <div className="flex lg:w-full justify-center items-center ">
        ...
        <button className='lg:px-[20px] px-[10px] lg:py-[10px] py-[10px] font-[500] lg:text-[14px] sm:text-xs uppercase border border-[rgb(94,94,94)] text-[10px] text-white cursor-pointer hover:bg-[gold] hover:font-semibold hover:text-black transition-all duration-300'>Sign Up / Sign In</button>
    </div>
